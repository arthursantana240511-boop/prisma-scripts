...
const SCRIPTS=[
 {slug:'delta',name:'script-roube um ovo',description:'Seu primeiro script do Prisma Scripts.',icon:'⚡',link:'https://raw.githubusercontent.com/Abdullahking20/loader-lua/main/loader'},
